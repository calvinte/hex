    ...
    describe('Map', function() {
        ...
        it('should wrap around', function(done) {
            define(['Map'], function(Map) {
                ...
                assert.deepEqual(map.resolveCoordinate(0, 3), [0, -2, 2]); // Corner
                assert.deepEqual(map.resolveCoordinate(-1, 3), [1, -2, 1]);
                assert.deepEqual(map.resolveCoordinate(-2, 3), [1, -2, 1]);
                assert.deepEqual(map.resolveCoordinate(-3, 3), [2, -2, 0]); // Corner
                assert.deepEqual(map.resolveCoordinate(-3, 2), [2, -1, -1]);
                assert.deepEqual(map.resolveCoordinate(-3, 1), [2, -1, -1]);
                assert.deepEqual(map.resolveCoordinate(-3, 0), [2, 0, -2]); // Corner
                assert.deepEqual(map.resolveCoordinate(-2, -1), [1, 1, -2]);
                assert.deepEqual(map.resolveCoordinate(-1, -2), [1, 1, -2]);
                assert.deepEqual(map.resolveCoordinate(0, -3), [0, 2, -2]); // Corner
                assert.deepEqual(map.resolveCoordinate(1, -3), [-1, 2, -1]);
                assert.deepEqual(map.resolveCoordinate(2, -3), [-1, 2, -1]);
                assert.deepEqual(map.resolveCoordinate(3, -3), [-2, 2,  0]); // Corner
                ...
                assert.deepEqual(map.resolveCoordinate(0, 4), [0, 2, -2]);
                assert.deepEqual(map.resolveCoordinate(-2, 4), [-1, 2, -1]);
                assert.deepEqual(map.resolveCoordinate(-4, 3), [-2, 1, 1]);
                assert.deepEqual(map.resolveCoordinate(1, -4), [1, -2, 1]);
                assert.deepEqual(map.resolveCoordinate(4, -1), [2, -1, -1]);
                assert.deepEqual(map.resolveCoordinate(2, 2), [-1, -1, 2]);

                // Even further...
                assert.deepEqual(map.resolveCoordinate(0, 5), [0, -2,  2]);
                assert.deepEqual(map.resolveCoordinate(0, 6), [0, 2, -2]);
                assert.deepEqual(map.resolveCoordinate(0, 9), [0, -2, 2]);
                assert.deepEqual(map.resolveCoordinate(0, 13), [0, -2, 2]);

                // All axis out-of-bounds.
                assert.deepEqual(map.resolveCoordinate(4, 9), [1, 1, -2]);
                assert.deepEqual(map.resolveCoordinate(4, 5), [1, 1, -2]);
